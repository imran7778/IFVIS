...
def get_loader_test(image_root, gt_root, trainsize):

    dataset = test_dataset(image_root, gt_root, trainsize)
    data_loader_test = data.DataLoader(dataset=dataset, batch_size=1, shuffle=False, num_workers=0, pin_memory=True)
